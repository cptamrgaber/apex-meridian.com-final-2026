    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900 opacity-90" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-4xl mx-auto">
            <span className="font-semibold">A p e x - M e r i d i a n ®</span> delivers cutting-edge AI solutions for aviation, cybersecurity, education, and AGI research
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/solutions"
              className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg font-semibold text-lg hover:from-cyan-600 hover:to-blue-600 transition-all transform hover:scale-105 shadow-xl"
            >
              Explore Solutions
            </Link>
            <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Link href="/solutions/aviation" className="group">
              <div className="bg-gradient-to-br from-blue-900/50 to-cyan-900/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-cyan-500/20 hover:border-cyan-500/50 transition-all transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-300">Predictive Accuracy</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-gray-300">Global Regions</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-900 via-cyan-900 to-blue-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/contact"
            className="inline-block px-10 py-5 bg-white text-blue-950 rounded-lg font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl"
          >
            Get Started Today
          </Link>
        </div>
