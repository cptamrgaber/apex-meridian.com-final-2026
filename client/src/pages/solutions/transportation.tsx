...
export default function Transportation() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Transportation & Logistics AI | Apex Meridian"
        description="Revolutionize transportation with AI-powered route optimization, autonomous systems, and fleet management"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Revolutionize transportation with AI-powered route optimization, autonomous systems, and fleet management
              </p>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardContent>
                  <p className="text-gray-300">Real-time traffic analysis and delivery planning</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Autonomous Systems</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Self-driving vehicles and drone delivery</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Vehicle tracking and maintenance scheduling</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Demand Prediction</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Capacity planning and resource allocation</p>
                </CardContent>
              </Card>
            </div>
          </div>
