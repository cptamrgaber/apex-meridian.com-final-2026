...
export default function Finance() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Financial Services AI | Apex Meridian"
        description="Revolutionize financial services with AI-driven risk management, fraud detection, and algorithmic trading"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Revolutionize financial services with AI-driven risk management, fraud detection, and algorithmic trading
              </p>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardContent>
                  <p className="text-gray-300">Real-time risk assessment and portfolio optimization</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Advanced pattern recognition and anomaly detection</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Algorithmic Trading</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">High-frequency trading and market prediction</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Personalized financial advice and product recommendations</p>
                </CardContent>
              </Card>
            </div>
          </div>
