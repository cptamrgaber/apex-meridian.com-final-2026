...
export default function Energy() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Energy & Utilities AI | Apex Meridian"
        description="Transform energy management with AI-powered grid optimization, renewable energy forecasting, and demand response"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Transform energy management with AI-powered grid optimization, renewable energy forecasting, and demand response
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Grid Optimization</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Load balancing and outage prediction</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Renewable Energy Forecasting</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Solar and wind power prediction</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Demand Response</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Energy consumption optimization</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Equipment monitoring and maintenance planning</p>
                </CardContent>
              </Card>
            </div>
          </div>
