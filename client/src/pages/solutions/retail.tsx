...
export default function Retail() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Retail & E-Commerce AI | Apex Meridian"
        description="Enhance retail operations with AI-powered personalization, inventory optimization, and customer insights"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Enhance retail operations with AI-powered personalization, inventory optimization, and customer insights
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Personalized Shopping</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Product recommendations and dynamic pricing</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Inventory Optimization</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Demand forecasting and stock management</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Behavior analysis and churn prediction</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Visual Search</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Image-based product discovery and recommendations</p>
                </CardContent>
              </Card>
            </div>
          </div>
