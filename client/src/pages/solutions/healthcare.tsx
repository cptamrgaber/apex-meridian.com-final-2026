...
export default function Healthcare() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Healthcare AI Solutions | Apex Meridian"
        description="Transform healthcare delivery with AI-powered diagnostics, patient care optimization, and medical research acceleration"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Transform healthcare delivery with AI-powered diagnostics, patient care optimization, and medical research acceleration
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-white">AI-Powered Diagnostics</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Advanced medical imaging analysis and disease detection</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Patient Care Optimization</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Personalized treatment plans and care coordination</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Medical Research Acceleration</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Drug discovery and clinical trial optimization</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Hospital Operations</CardTitle>
                </CardHeader>
                <CardContent>
