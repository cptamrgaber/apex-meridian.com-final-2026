...
export default function Press() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Press & Media | Apex Meridian"
        description="Latest news coverage, press releases, and media resources"
      />
      <Header />
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Latest news coverage, press releases, and media resources
            </p>
          </div>
