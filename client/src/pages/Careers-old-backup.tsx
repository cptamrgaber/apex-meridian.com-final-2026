...
export default function Careers() {
  ...
  const allJobs = [
    ...
    { title: "Business Development Manager - Aviation", department: "Sales & Business Development", location: "Cairo, Egypt", type: "Full-time", description: "Expand our client base in the aviation industry across Egypt, North Africa, Middle East, and Africa.", available: true },
