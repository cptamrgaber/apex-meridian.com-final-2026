...
export default function Robotics() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Robotics & Automation | Apex Meridian"
        description="Intelligent robotics systems combining AI with mechanical engineering for autonomous operations"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Intelligent robotics systems combining AI with mechanical engineering for autonomous operations
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Autonomous Navigation</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Path planning and obstacle avoidance</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Manipulation</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Object grasping and assembly operations</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Human-Robot Collaboration</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Safe interaction and cooperation</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Swarm Intelligence</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Coordinated multi-robot systems</p>
                </CardContent>
              </Card>
            </div>
          </div>
