...
export default function ComputerVision() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Computer Vision | Apex Meridian"
        description="Advanced computer vision systems for image and video analysis, object detection, and recognition"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Advanced computer vision systems for image and video analysis, object detection, and recognition
              </p>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardContent>
                  <p className="text-gray-300">Real-time object identification and tracking</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Image Classification</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Automated image categorization</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Identity verification and authentication</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Motion detection and activity recognition</p>
                </CardContent>
              </Card>
            </div>
          </div>
