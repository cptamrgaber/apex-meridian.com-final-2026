...
export default function MachineLearning() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-950 via-blue-900 to-cyan-900">
      <SEO
        title="Machine Learning | Apex Meridian"
        description="Advanced machine learning algorithms and frameworks powering intelligent decision-making systems"
      />
      <Header />
          ...
          <div className="container mx-auto relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Advanced machine learning algorithms and frameworks powering intelligent decision-making systems
              </p>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <CardHeader>
                  ...
                  <CardTitle className="text-white">Supervised Learning</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Classification and regression models</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                  <CheckCircle className="h-8 w-8 text-cyan-400 mb-4" />
                  <CardTitle className="text-white">Unsupervised Learning</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-300">Clustering and dimensionality reduction</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Autonomous decision-making agents</p>
                </CardContent>
              </Card>
              <Card className="bg-blue-900/50 backdrop-blur-sm border-cyan-500/20">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-gray-300">Neural networks and advanced architectures</p>
                </CardContent>
              </Card>
            </div>
          </div>
